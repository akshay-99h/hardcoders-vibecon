...
## Testing Guidelines
1. Test with real document images (legal notices, certificates, etc.)
2. Verify OCR accuracy for both English and Hindi text
3. Test file size limits (up to 10MB)
4. Test invalid file formats and ensure proper error handling
5. Verify that extracted text is correctly analyzed by the AI
6. Test the full flow: upload → OCR → analysis → response
