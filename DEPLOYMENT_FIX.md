...
2. Browser sends to same domain (e.g., `https://rti-helper-bot.preview.emergentagent.com/api/missions`)
...
2. Redirects to `https://auth.emergentagent.com/?redirect=https://rti-helper-bot.preview.emergentagent.com/dashboard`
...
curl https://rti-helper-bot.preview.emergentagent.com/api/health
