...
2. Browser sends to same domain (e.g., `https://legal-rights-chat.preview.emergentagent.com/api/missions`)
...
2. Redirects to `https://auth.emergentagent.com/?redirect=https://legal-rights-chat.preview.emergentagent.com/dashboard`
...
curl https://legal-rights-chat.preview.emergentagent.com/api/health
